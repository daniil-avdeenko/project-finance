...
from app.models import (
    ...
    IncomeCategory, ExpenseCategory, Transaction
)
...
def seed():
    ...
    with app.app_context():
        ...
        project_defs = [
            {
                ...
                'expense_cats': ['Внутренние программисты', 'Внешние программисты', 'Аренда сервера',
                                 'Маркетинг', 'Налоги и сборы'],
            ...
            },
            {
                ...
                'expense_cats': ['Внешние программисты', 'Командировки', 'Юридические услуги', 'Налоги и сборы'],
            ...
            },
            {
                ...
                'expense_cats': ['Внутренние программисты', 'Расходы на ИИ', 'Маркетинг', 'Налоги и сборы'],
            ...
            },
            {
                ...
                'expense_cats': ['Внутренние программисты', 'Аренда сервера', 'Расходы на ИИ', 'Налоги и сборы'],
            ...
            },
            {
                ...
                'expense_cats': ['Внутренние программисты', 'Командировки', 'Налоги и сборы'],
            ...
            },
            {
                ...
                'expense_cats': ['Внутренние программисты', 'Внешние программисты', 'Налоги и сборы'],
        ...
        for proj_idx, project in enumerate(projects):
            ...
            start_date = project.created_at.replace(tzinfo=timezone.utc)
            end_date = now
            ...
            while current < end_date:
                ...
                for _ in range(num_income):
                    ...
                    t_date = current.replace(day=min(day, 28)) + timedelta(days=random.randint(0, 2))
                    t_date = t_date.replace(hour=random.randint(9, 17), minute=random.choice([0, 30]))
                    if t_date > end_date:
